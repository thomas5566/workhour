      ...
      <div class='box-body'>
        <div class='row'>
          ...
          <div class='col-md-4'>
            ...
            <va-chart :chart-config='lineChartConfig'>
            </va-chart>
          </div>
          <div class='col-md-4'>
            <p class='text-center'>
            ...
            <va-chart :chart-config='barChartConfig'>
            </va-chart>
          </div>
        </div>
      </div>
      ...
      <div class='box-body'>
        <div class='row'>
          <div class='col-md-4'>
            ...
            <va-chart :chart-config='radarChartConfig'>
            </va-chart>
          </div>
          <div class='col-md-4'>
            <p class='text-center'>
            ...
            <va-chart :chart-config='polarAreaChartConfig'>
            </va-chart>
          </div>
          <div class='col-md-4'>
            <p class='text-center'>
            ...
            <va-chart :chart-config='doughnutChartConfig'>
            </va-chart>
          </div>
        </div>
      </div>
